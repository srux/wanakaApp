...
(function() {
	...
	module.exports = L.Control.extend({
		...
		_createAlternative: function(alt, i) {
            ...
            let distanceMeters = alt.summary.totalDistance / 1000;
            document.getElementById('distance').innerHTML = distanceMeters.toFixed(1);
            console.log(this.options.totalDistanceRoundingSensitivity);
